...
class OrderItemTest {
    ...
    void restaurantTest() throws Exception {
        ...
        orderItem.setRestaurant(restaurantBack);
        assertThat(orderItem.getRestaurant()).isEqualTo(restaurantBack);

        orderItem.restaurant(null);
        assertThat(orderItem.getRestaurant()).isNull();
    }

    @Test
    void orderAssignedToTest() throws Exception {
        OrderItem orderItem = getOrderItemRandomSampleGenerator();
        ApplicationUser applicationUserBack = getApplicationUserRandomSampleGenerator();

        orderItem.setOrderAssignedTo(applicationUserBack);
        assertThat(orderItem.getOrderAssignedTo()).isEqualTo(applicationUserBack);

        orderItem.orderAssignedTo(null);
        assertThat(orderItem.getOrderAssignedTo()).isNull();
    }
