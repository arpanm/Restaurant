...
public class ApplicationUserTestSamples {
    ...
    public static ApplicationUser getApplicationUserSample1() {
        return new ApplicationUser().id(1L).name("name1").password("password1").email("email1").phone("phone1");
    }

    public static ApplicationUser getApplicationUserSample2() {
        return new ApplicationUser().id(2L).name("name2").password("password2").email("email2").phone("phone2");
    }
