...
class MealPlanTest {
    ...
    void orderItemTest() throws Exception {
        ...
        mealPlan.setOrderItem(orderItemBack);
        assertThat(mealPlan.getOrderItem()).isEqualTo(orderItemBack);
        assertThat(orderItemBack.getMeal()).isEqualTo(mealPlan);

        mealPlan.orderItem(null);
        assertThat(mealPlan.getOrderItem()).isNull();
        assertThat(orderItemBack.getMeal()).isNull();
    }
}
