...
import com.restaurant.angikar.repository.OrderRepository;
import com.restaurant.angikar.service.dto.OrderDTO;
import com.restaurant.angikar.service.mapper.OrderMapper;
...
class OrderResourceIT {
    ...
    void createOrder() throws Exception {
        ...
        assertThat(testOrder.getCouponValue()).isEqualTo(DEFAULT_COUPON_VALUE);
    }
    ...
    void putExistingOrder() throws Exception {
        ...
        updatedOrder.status(UPDATED_STATUS).orderDate(UPDATED_ORDER_DATE).amount(UPDATED_AMOUNT).couponValue(UPDATED_COUPON_VALUE);
        ...
        assertThat(testOrder.getCouponValue()).isEqualTo(UPDATED_COUPON_VALUE);
    }
    ...
    void partialUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.status(UPDATED_STATUS).amount(UPDATED_AMOUNT);
    ...
    void fullUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.status(UPDATED_STATUS).orderDate(UPDATED_ORDER_DATE).amount(UPDATED_AMOUNT).couponValue(UPDATED_COUPON_VALUE);
