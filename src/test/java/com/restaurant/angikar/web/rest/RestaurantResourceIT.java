...
class RestaurantResourceIT {
    ...
    private static final RestaurantType DEFAULT_TYPE = RestaurantType.MultiCusion;
    private static final RestaurantType UPDATED_TYPE = RestaurantType.CloudKitchen;
    ...
    void putExistingRestaurant() throws Exception {
        ...
        updatedRestaurant.restaurantName(UPDATED_RESTAURANT_NAME).title(UPDATED_TITLE).logo(UPDATED_LOGO).type(UPDATED_TYPE);
    ...
    void partialUpdateRestaurantWithPatch() throws Exception {
        ...
        partialUpdatedRestaurant.title(UPDATED_TITLE).logo(UPDATED_LOGO);
    ...
    void fullUpdateRestaurantWithPatch() throws Exception {
        ...
        partialUpdatedRestaurant.restaurantName(UPDATED_RESTAURANT_NAME).title(UPDATED_TITLE).logo(UPDATED_LOGO).type(UPDATED_TYPE);
