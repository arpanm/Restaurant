...
import com.restaurant.angikar.repository.CartRepository;
import com.restaurant.angikar.service.dto.CartDTO;
import com.restaurant.angikar.service.mapper.CartMapper;
...
class CartResourceIT {
    ...
    public static Cart createEntity(EntityManager em) {
        Cart cart = new Cart().status(DEFAULT_STATUS);
        return cart;
    }
    ...
    public static Cart createUpdatedEntity(EntityManager em) {
        Cart cart = new Cart().status(UPDATED_STATUS);
        return cart;
    }
    ...
    void putExistingCart() throws Exception {
        ...
        updatedCart.status(UPDATED_STATUS);
    ...
    void fullUpdateCartWithPatch() throws Exception {
        ...
        partialUpdatedCart.status(UPDATED_STATUS);
