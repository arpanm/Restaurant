...
public class Location implements Serializable {
    ...
    @OneToOne(fetch = FetchType.LAZY, mappedBy = "deliveryLocation")
    ...
    public void setRestaurant(Restaurant restaurant) {
        if (this.restaurant != null) {
            this.restaurant.setLocation(null);
        }
        if (restaurant != null) {
    ...
    public void setMealPlanItem(MealPlanItem mealPlanItem) {
        if (this.mealPlanItem != null) {
            this.mealPlanItem.setDeliveryLocation(null);
        }
        if (mealPlanItem != null) {
            mealPlanItem.setDeliveryLocation(this);
        }
        this.mealPlanItem = mealPlanItem;
    }

    public Location mealPlanItem(MealPlanItem mealPlanItem) {
    ...
    public void setOrderItem(OrderItem orderItem) {
        if (this.orderItem != null) {
            this.orderItem.setDeliveryLoc(null);
        }
        if (orderItem != null) {
            orderItem.setDeliveryLoc(this);
        }
        this.orderItem = orderItem;
    }

    public Location orderItem(OrderItem orderItem) {
    ...
    public void setOrder(Order order) {
        if (this.order != null) {
            this.order.setBillingLoc(null);
        }
        if (order != null) {
            order.setBillingLoc(this);
        }
        this.order = order;
    }

    public Location order(Order order) {
        this.setOrder(order);
        return this;
    }
