...
public class Item implements Serializable {
    ...
    public void setItemPincodeMappings(Set<ItemPincodeMapping> itemPincodeMappings) {
        if (this.itemPincodeMappings != null) {
            this.itemPincodeMappings.forEach(i -> i.setItem(null));
        }
        if (itemPincodeMappings != null) {
            itemPincodeMappings.forEach(i -> i.setItem(this));
        }
        this.itemPincodeMappings = itemPincodeMappings;
    }

    public Item itemPincodeMappings(Set<ItemPincodeMapping> itemPincodeMappings) {
        this.setItemPincodeMappings(itemPincodeMappings);
        return this;
    }

    public Item addItemPincodeMapping(ItemPincodeMapping itemPincodeMapping) {
        this.itemPincodeMappings.add(itemPincodeMapping);
        itemPincodeMapping.setItem(this);
        return this;
    }

    public Item removeItemPincodeMapping(ItemPincodeMapping itemPincodeMapping) {
        this.itemPincodeMappings.remove(itemPincodeMapping);
        itemPincodeMapping.setItem(null);
        return this;
    }
    ...
    public Item orderItem(OrderItem orderItem) {
