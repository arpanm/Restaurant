...
public class ApplicationUser implements Serializable {
    ...
    @OneToMany(fetch = FetchType.LAZY, mappedBy = "usr")
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    @JsonIgnoreProperties(value = { "items", "usr" }, allowSetters = true)
    ...
    public void setMealPlans(Set<MealPlan> mealPlans) {
        if (this.mealPlans != null) {
            this.mealPlans.forEach(i -> i.setUsr(null));
        }
        if (mealPlans != null) {
            mealPlans.forEach(i -> i.setUsr(this));
        }
        this.mealPlans = mealPlans;
    }

    public ApplicationUser mealPlans(Set<MealPlan> mealPlans) {
        this.setMealPlans(mealPlans);
        return this;
    }

    public ApplicationUser addMealPlan(MealPlan mealPlan) {
        this.mealPlans.add(mealPlan);
        mealPlan.setUsr(this);
        return this;
    }

    public ApplicationUser removeMealPlan(MealPlan mealPlan) {
        this.mealPlans.remove(mealPlan);
        mealPlan.setUsr(null);
        return this;
    }
    ...
    public void setCarts(Set<Cart> carts) {
        if (this.carts != null) {
            this.carts.forEach(i -> i.setUsr(null));
        }
        if (carts != null) {
            carts.forEach(i -> i.setUsr(this));
        }
        this.carts = carts;
    }

    public ApplicationUser carts(Set<Cart> carts) {
        this.setCarts(carts);
        return this;
    }

    public ApplicationUser addCart(Cart cart) {
        this.carts.add(cart);
        cart.setUsr(this);
        return this;
    }

    public ApplicationUser removeCart(Cart cart) {
