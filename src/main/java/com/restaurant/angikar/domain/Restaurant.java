...
public class Restaurant implements Serializable {
    ...
    @OneToMany(fetch = FetchType.LAZY, mappedBy = "restaurant")
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    @JsonIgnoreProperties(value = { "item", "restaurant" }, allowSetters = true)
    private Set<ItemPincodeMapping> itemPincodeMappings = new HashSet<>();
    ...
    public Set<ItemPincodeMapping> getItemPincodeMappings() {
        return this.itemPincodeMappings;
    }

    public void setItemPincodeMappings(Set<ItemPincodeMapping> itemPincodeMappings) {
        if (this.itemPincodeMappings != null) {
            this.itemPincodeMappings.forEach(i -> i.setRestaurant(null));
        }
        if (itemPincodeMappings != null) {
            itemPincodeMappings.forEach(i -> i.setRestaurant(this));
        }
        this.itemPincodeMappings = itemPincodeMappings;
    }

    public Restaurant itemPincodeMappings(Set<ItemPincodeMapping> itemPincodeMappings) {
        this.setItemPincodeMappings(itemPincodeMappings);
        return this;
    }

    public Restaurant addItemPincodeMapping(ItemPincodeMapping itemPincodeMapping) {
        this.itemPincodeMappings.add(itemPincodeMapping);
        itemPincodeMapping.setRestaurant(this);
        return this;
    }

    public Restaurant removeItemPincodeMapping(ItemPincodeMapping itemPincodeMapping) {
        this.itemPincodeMappings.remove(itemPincodeMapping);
        itemPincodeMapping.setRestaurant(null);
        return this;
    }
    ...
    public void setOrderItem(OrderItem orderItem) {
        if (this.orderItem != null) {
            this.orderItem.setRestaurant(null);
        }
        if (orderItem != null) {
            orderItem.setRestaurant(this);
        }
        this.orderItem = orderItem;
    }

    public Restaurant orderItem(OrderItem orderItem) {
