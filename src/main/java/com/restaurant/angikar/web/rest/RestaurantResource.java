...
/**
 * REST controller for managing {@link com.restaurant.angikar.domain.Restaurant}.
 */
@RestController
...
public class RestaurantResource {
    ...
    public ResponseEntity<List<RestaurantDTO>> getAllRestaurants(
        ...
        if ("orderitem-is-null".equals(filter)) {
            log.debug("REST request to get all Restaurants where orderItem is null");
            return new ResponseEntity<>(restaurantService.findAllWhereOrderItemIsNull(), HttpStatus.OK);
        }
