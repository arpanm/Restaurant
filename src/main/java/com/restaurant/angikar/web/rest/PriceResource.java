...
/**
 * REST controller for managing {@link com.restaurant.angikar.domain.Price}.
 */
@RestController
...
public class PriceResource {
    ...
    public ResponseEntity<List<PriceDTO>> getAllPrices(
        ...
        if ("item-is-null".equals(filter)) {
            log.debug("REST request to get all Prices where item is null");
            return new ResponseEntity<>(priceService.findAllWhereItemIsNull(), HttpStatus.OK);
        }
