...
/**
 * REST controller for managing {@link com.restaurant.angikar.domain.Item}.
 */
@RestController
...
public class ItemResource {
    ...
    public ResponseEntity<List<ItemDTO>> getAllItems(
        ...
        if ("cartitem-is-null".equals(filter)) {
            log.debug("REST request to get all Items where cartItem is null");
            return new ResponseEntity<>(itemService.findAllWhereCartItemIsNull(), HttpStatus.OK);
        }

        if ("orderitem-is-null".equals(filter)) {
            log.debug("REST request to get all Items where orderItem is null");
            return new ResponseEntity<>(itemService.findAllWhereOrderItemIsNull(), HttpStatus.OK);
        }
