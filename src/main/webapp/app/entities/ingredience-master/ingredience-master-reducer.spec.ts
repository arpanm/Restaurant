...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './ingredience-master.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INGREDIENCEMASTER_LIST actions', async () => {
    ...
    it('dispatches FETCH_INGREDIENCEMASTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INGREDIENCEMASTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INGREDIENCEMASTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INGREDIENCEMASTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INGREDIENCEMASTER actions', async () => {
      const expectedActions = [
        {
