...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PINCODEMASTER_LIST actions', async () => {
    ...
    it('dispatches FETCH_PINCODEMASTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PINCODEMASTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PINCODEMASTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PINCODEMASTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PINCODEMASTER actions', async () => {
      const expectedActions = [
        {
