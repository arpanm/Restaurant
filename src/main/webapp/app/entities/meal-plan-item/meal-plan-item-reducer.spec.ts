...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEALPLANITEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_MEALPLANITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MEALPLANITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MEALPLANITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MEALPLANITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MEALPLANITEM actions', async () => {
      const expectedActions = [
        {
