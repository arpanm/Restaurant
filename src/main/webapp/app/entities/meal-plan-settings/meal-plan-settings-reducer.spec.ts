...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './meal-plan-settings.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEALPLANSETTINGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_MEALPLANSETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MEALPLANSETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MEALPLANSETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MEALPLANSETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MEALPLANSETTINGS actions', async () => {
      const expectedActions = [
        {
