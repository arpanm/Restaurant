...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './qty-unit.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_QTYUNIT_LIST actions', async () => {
    ...
    it('dispatches FETCH_QTYUNIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_QTYUNIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_QTYUNIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_QTYUNIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_QTYUNIT actions', async () => {
      const expectedActions = [
        {
