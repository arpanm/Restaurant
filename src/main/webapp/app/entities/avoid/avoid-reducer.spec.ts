...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './avoid.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AVOID_LIST actions', async () => {
    ...
    it('dispatches FETCH_AVOID actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AVOID actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AVOID actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AVOID actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AVOID actions', async () => {
      const expectedActions = [
        {
