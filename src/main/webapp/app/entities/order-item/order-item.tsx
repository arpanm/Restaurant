            ...
            <Table responsive>
              <thead>
                <tr>
                  ...
                  <th>
                    <Translate contentKey="restaurantApp.orderItem.restaurant">Restaurant</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
              ...
              <tbody>
                {orderItemList.map((orderItem, i) => (
                  <tr key={`entity-${i}`} data-cy="entityTable">
                    ...
                    <td>
                      {orderItem.restaurant ? <Link to={`/restaurant/${orderItem.restaurant.id}`}>{orderItem.restaurant.id}</Link> : ''}
                    </td>
                    <td>
                      {orderItem.orderAssignedTo ? (
                        <Link to={`/application-user/${orderItem.orderAssignedTo.id}`}>{orderItem.orderAssignedTo.id}</Link>
                      ) : (
                        ''
                      )}
                    </td>
