    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="restaurantApp.order.usr">Usr</Translate>
          </dt>
          <dd>{orderEntity.usr ? orderEntity.usr.id : ''}</dd>
          <dt>
            <Translate contentKey="restaurantApp.order.statusUpdatedBy">Status Updated By</Translate>
          </dt>
          <dd>{orderEntity.statusUpdatedBy ? orderEntity.statusUpdatedBy.id : ''}</dd>
        </dl>
