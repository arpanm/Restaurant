...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './meal-plan.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEALPLAN_LIST actions', async () => {
    ...
    it('dispatches FETCH_MEALPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MEALPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MEALPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MEALPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MEALPLAN actions', async () => {
      const expectedActions = [
        {
