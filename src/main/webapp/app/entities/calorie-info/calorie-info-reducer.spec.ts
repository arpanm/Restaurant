...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CALORIEINFO_LIST actions', async () => {
    ...
    it('dispatches FETCH_CALORIEINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CALORIEINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CALORIEINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CALORIEINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CALORIEINFO actions', async () => {
      const expectedActions = [
        {
