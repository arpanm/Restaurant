...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './item-pincode-mapping.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ITEMPINCODEMAPPING_LIST actions', async () => {
    ...
    it('dispatches FETCH_ITEMPINCODEMAPPING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ITEMPINCODEMAPPING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ITEMPINCODEMAPPING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ITEMPINCODEMAPPING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ITEMPINCODEMAPPING actions', async () => {
      const expectedActions = [
        {
