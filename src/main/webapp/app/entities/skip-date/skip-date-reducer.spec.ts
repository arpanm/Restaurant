...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './skip-date.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SKIPDATE_LIST actions', async () => {
    ...
    it('dispatches FETCH_SKIPDATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SKIPDATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SKIPDATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SKIPDATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SKIPDATE actions', async () => {
      const expectedActions = [
        {
