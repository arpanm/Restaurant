...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FOODCATEGORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_FOODCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FOODCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FOODCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FOODCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FOODCATEGORY actions', async () => {
      const expectedActions = [
        {
