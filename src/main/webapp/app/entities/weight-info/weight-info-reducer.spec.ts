...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WEIGHTINFO_LIST actions', async () => {
    ...
    it('dispatches FETCH_WEIGHTINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WEIGHTINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WEIGHTINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WEIGHTINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WEIGHTINFO actions', async () => {
      const expectedActions = [
        {
