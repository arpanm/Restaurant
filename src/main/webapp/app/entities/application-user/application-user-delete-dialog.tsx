...
export const ApplicationUserDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="restaurantApp.applicationUser.delete.question">
        <Translate contentKey="restaurantApp.applicationUser.delete.question" interpolate={{ id: applicationUserEntity.id }}>
